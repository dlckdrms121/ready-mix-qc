const sessionId = window.__RT_SESSION_ID__;
...
async function pollRealtime() {
  ...
  if (!res.ok) {
    throw new Error(data.detail || 'Failed to load realtime session');
  }
  ...
  overlayLink.href = artifacts.overlay_video || '#';
  traceLink.href = artifacts.trace_csv || '#';
